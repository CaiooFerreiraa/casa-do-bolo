...
export default function Home() {
  ...
  return (
    <div className="min-h-screen bg-background text-foreground">
        ...
        <div className="max-w-7xl mx-auto grid lg:grid-cols-2 gap-16 items-center relative z-10 w-full">
          <div className="max-w-2xl space-y-10 relative">
            ...
            <div className="flex items-center gap-6 pt-4">
              <Link
                href="/cardapio"
                className="bg-primary text-primary-foreground px-10 py-5 rounded-full font-medium tracking-wide hover:bg-primary/90 transition-all active:scale-95 flex items-center gap-2 cursor-pointer shadow-xl shadow-primary/20 text-lg"
              >
                Ver Cardápio
              ...
              <Link
                href="/carrinho"
                className="px-8 py-5 rounded-full font-medium tracking-wide text-foreground hover:bg-muted/50 transition-colors cursor-pointer text-lg"
              >
                Meu Carrinho
              </Link>
            </div>
          ...
          <div className="relative h-[600px] lg:h-[750px] w-full rounded-[2.5rem] overflow-hidden shadow-2xl shadow-primary/10">
            <Image
      ...
      {/* Featured Products */}
      <section className="py-32 px-6 bg-accent/40 rounded-t-[4rem] relative mt-12 border-t border-border/50">
        <div className="max-w-7xl mx-auto">
          <div className="flex flex-col md:flex-row justify-between items-end gap-6 mb-20">
            <div className="space-y-4">
              <h2 className="text-5xl title text-foreground">Nossos Destaques</h2>
            ...
            <Link
              href="/cardapio"
              className="hidden sm:inline-flex items-center gap-2 text-primary hover:text-primary/70 transition-colors font-medium border-b border-primary/20 hover:border-primary/70 pb-1 cursor-pointer"
            >
      ...
      {/* Footer */}
      <footer id="contato" className="bg-primary text-primary-foreground py-24 px-6 relative overflow-hidden rounded-t-[3rem] -mt-8">
        <div className="max-w-7xl mx-auto grid md:grid-cols-12 gap-16 relative z-10">
          <div className="md:col-span-5">
            <h4 className="text-4xl title mb-8">Casa do Bolo</h4>
          ...
          <div id="sobre" className="md:col-span-2">
            <h5 className="font-serif text-xl mb-8 opacity-90">Navegação</h5>
            <ul className="space-y-4">
              <li><Link href="/" className="text-primary-foreground/70 hover:text-primary-foreground transition-colors inline-block">Início</Link></li>
              <li><Link href="/cardapio" className="text-primary-foreground/70 hover:text-primary-foreground transition-colors inline-block">Cardápio</Link></li>
              <li><Link href="/carrinho" className="text-primary-foreground/70 hover:text-primary-foreground transition-colors inline-block">Carrinho</Link></li>
            </ul>
          </div>
          <div className="md:col-span-2">
            <h5 className="font-serif text-xl mb-8 opacity-90">Admin</h5>
            <ul className="space-y-4">
              <li>
                <Link
                  href="/admin"
                  className="text-primary-foreground/70 hover:text-primary-foreground transition-colors inline-flex items-center gap-2"
                >
          ...
          <div className="md:col-span-3">
            <h5 className="font-serif text-xl mb-8 opacity-90">Contato</h5>
        ...
        <div className="max-w-7xl mx-auto mt-24 pt-8 border-t border-primary-foreground/20 text-center text-primary-foreground/50 text-sm font-light tracking-wide">
